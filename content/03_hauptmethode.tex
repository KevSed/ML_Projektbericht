...
%
\begin{figure}[h!]
  \subcaptionbox{\label{fig:g}}{\includegraphics[width=0.5\textwidth]{Plots/confusion_matrix_smaller.pdf}}
  \hspace{8pt}
  \subcaptionbox{\label{fig:ug}}{\includegraphics[width=0.5\textwidth]{Plots/confusion_matrix_equal.pdf}}
