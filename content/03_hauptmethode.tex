...
%
\begin{figure}[h!]
  \subcaptionbox{Die Verwirrungsmatrix für das gewichtete Training.}{\includegraphics[width=0.5\textwidth]{Plots/confusion_matrix_smaller.pdf}}
  \hspace{8pt}
  \subcaptionbox{Die Verwirrungsmatrix für das ungewichtete Training.}{\includegraphics[width=0.5\textwidth]{Plots/confusion_matrix_equal.pdf}}
  \label{fig:eq_all}
\end{figure}
%
